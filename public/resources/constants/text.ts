...
import {
    ...
    recommendedOutfitsContentSky,
    recommendedOutfitsContentBlue,
    recommendedOutfitsContentIndigo,
    recommendedOutfitsContentNavy,
} from '@/styles/styles';
...
export const RECOMMENDED_OUTFITS: RecommendedOutfitType[] = [
    ...
    },
    {
        ...
        img: ['/resources/img/summer-t-shirt.png', '/resources/img/summer-pants.png'],
    },
    {
        id: 'DEGREE_20',
        degree: '20℃ ~ 22℃',
        ...
        img: ['/resources/img/pink-blouse.png', '/resources/img/tshirt.png'],
    },
    {
        id: 'DEGREE_17',
        degree: '17℃ ~ 19℃',
        ...
        img: ['/resources/img/hood.png', '/resources/img/knitted-jumper.png'],
    },
    {
        id: 'DEGREE_12',
        degree: '12℃ ~ 16℃',
        outfits: ['자켓', '가디건', '청자켓', '니트', '스타킹', '청바지'],
        class: recommendedOutfitsContentSky,
        img: ['/resources/img/jumper.png', '/resources/img/blue-pants.png'],
    },
    {
        id: 'DEGREE_9',
        degree: '9℃ ~ 11℃',
        outfits: ['트렌치코트', '야상', '점퍼', '스타킹', '기모바지'],
        class: recommendedOutfitsContentBlue,
        img: ['/resources/img/coat.png', '/resources/img/coat2.png'],
    },
    {
        id: 'DEGREE_5',
        degree: '5℃ ~ 8℃',
        outfits: ['울 코트', '히트텍', '가죽 옷', '기모'],
        class: recommendedOutfitsContentIndigo,
        img: ['/resources/img/wool-coat.png', '/resources/img/cardigan.png'],
    },
    {
        id: 'DEGREE_4',
        degree: '4℃ 이하',
        outfits: ['패딩', '두꺼운 코트', '누빔 옷', '기모', '목도리'],
        class: recommendedOutfitsContentNavy,
        img: ['/resources/img/winter-hat.png', '/resources/img/padding.png'],
    },
];
